...
app.post("/api/chat", async (req, res) => {
  try {
    ...
    const botResponse =
      "I'm Navie, your e-waste recycling assistant. I can help you with information about e-waste recycling, pricing estimates, and our collection process. What would you like to know?";
